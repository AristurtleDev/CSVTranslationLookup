...
//////            _settingsWatcher = new FileSystemWatcher(Path.GetDirectoryName(_settings.SettingsFilePath), Constants.CONFIGURATION_FILENAME);
...
//////            {
//////                throw new InvalidOperationException($"There was an issue reading the {Constants.CONFIGURATION_FILENAME} settings file");
//////            }
